...
import { Container, Row, Col, Table, Button, Form, Card, Breadcrumb } from "react-bootstrap"
...
const CartPage = () => {
    ...
    const handleQuantityChange = (id, newQuantity) => {
        setCartItems(cartItems.map((item) => (item.id === id ? { ...item, quantity: Number.parseInt(newQuantity) } : item)))
    }
