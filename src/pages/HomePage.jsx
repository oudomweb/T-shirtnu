...
import {FaShippingFast, FaUndo, FaHeadset, FaCreditCard, FaInstagram} from "react-icons/fa"
                    ...
                    <Row className="g-2">
                        ...
                        {KhmerImages.map((imgSrc, index) => (
                            <Col md={2} sm={4} xs={6} key={index}>
                                ...
                                <div className="instagram-item position-relative overflow-hidden">
                                    <img src={imgSrc} alt={`Instagram post ${index + 1}`} className="img-fluid" />
                                    <div className="instagram-overlay position-absolute top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center" style={{ background: 'rgba(255,255,255,0.6)', zIndex: 1 }}>
