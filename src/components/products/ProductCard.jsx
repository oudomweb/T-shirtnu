        ...
        <Card className="product-card border-0 h-100">
            <div className="card-img-container">
                ...
                <div className="hover-overlay">
                    <Button variant="link" className="text-white p-1 " style={{textDecoration: 'none' }}>
                ...
                {product.colors && (
                    <div className="color-options mt-2 border-4">
                        {product.colors.map((color, index) => (
                            <span key={index} className="color-option border " style={{ backgroundColor: color }} title={color}></span>
                        ))}
                    </div>
                )}
            </Card.Body>
